...
CREATE TABLE IF NOT EXISTS `mydb`.`tb_company` (
  ...
  CONSTRAINT `fk_tb_company_tb_city1`
    FOREIGN KEY (`city_ID`)
    REFERENCES `mydb`.`tb_city` (`city_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`tb_routes` (
  ...
  CONSTRAINT `fk_tb_routes_tb_company`
    FOREIGN KEY (`company_ID`)
    REFERENCES `mydb`.`tb_company` (`company ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_routes_tb_city1`
    FOREIGN KEY (`city_ID`)
    REFERENCES `mydb`.`tb_city` (`city_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `mydb`.`tb_schedules` (
  ...
  CONSTRAINT `fk_tb_schedules_tb_city1`
    FOREIGN KEY (`city_ID`)
    REFERENCES `mydb`.`tb_city` (`city_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `mydb`.`tb_user` (
  ...
  CONSTRAINT `fk_tb_user_tb_privileges1`
    FOREIGN KEY (`privilege_ID`)
    REFERENCES `mydb`.`tb_privileges` (`privilege_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `mydb`.`tb_vehicle` (
  ...
  CONSTRAINT `fk_tb_vehicle_tb_city1`
    FOREIGN KEY (`city_ID`)
    REFERENCES `mydb`.`tb_city` (`city_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_vehicle_tb_company1`
    FOREIGN KEY (`company_ID`)
    REFERENCES `mydb`.`tb_company` (`company ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_vehicle_tb_routes1`
    FOREIGN KEY (`route_number`)
    REFERENCES `mydb`.`tb_routes` (`route_number`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
