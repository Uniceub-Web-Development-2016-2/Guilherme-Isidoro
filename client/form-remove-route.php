	...
	<body>
		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
					<h2 class="sub-header">Remover linha</h2>
					<form action="form-remove-route-by-number.php" method="post">
						<div class="form-group">
							<div class="input-group">
								<span class="input-group-btn">
								<button class="btn btn-default" type="submit">Buscar</button>
								</span>
								<input type="text" class="form-control" name="id" required placeholder="Número da linha">
							</div>
						</div>
					</form>
				</div>
		...
		<script>
			...
			function getTime() {
				...
				var hour = H+':'+M;
				document.getElementById("userTime").value = hour;
			}
