		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
					<h2 class="sub-header">Cadastrar novo usuário</h2>
					<form action="form-new-user.php" method="post">
						<div class="form-group">
							<label for="name">Nome</label>
							<input type="text" name="name" placeholder="Nome do usuário" required class="form-control"><br>
						</div>
						<div class="form-group">
						...
						<?php
							if ($_SESSION['privilege'] == 1) {
								...
								echo '<div class="form-group">
								      <label for="idprivilege">Perfil</label>
								      <select class="form-control" name="privilege_ID">
								      <option>1</option>
								      <option>2</option>
							              </select>
						                      </div>';
								...
								echo '<div class="form-group">
								      <label for="idprivilege">Perfil</label>
								      <select class="form-control" readonly name="privilege_ID">
								      <option>1</option>
							              </select>
						                      </div>';
							   }						
