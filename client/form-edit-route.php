      ...
      <div class="container-fluid">
         <div class="row">
            ...
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
               <h2 class="sub-header">Editar Linha</h2>
               <form action="form-edit-route-by-number.php" method="get">
                  <div class="form-group">
                     <div class="input-group">
                        <span class="input-group-btn">
                        <button class="btn btn-default" type="submit">Buscar</button>
                        </span>
                        <input type="text" class="form-control" name="id" placeholder="Número da Linha" required onkeydown="this.value=removeSpaces(this.value)">
